...
// Returns the current item to its proper persistent inventory. Unique rewards
// such as Mega Stone and Lucky Egg live in ownedMachines, not the counted array.
